...
class KnowFriend extends StatefulWidget {
  const KnowFriend({Key? key}) : super(key: key);

  @override
  State<KnowFriend> createState() => _KnowFriend();
}


class _KnowFriend extends State<KnowFriend> {
                                              ...
                                              child: ElevatedButton(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                   ...
                                                   Padding(
                                                    padding:EdgeInsets.only(left: width *0.031)
                                                   ),
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor: Color(0xFF9A68C2),
                                        shape: RoundedRectangleBorder(
                                            borderRadius:
                                              BorderRadius.circular(width * 0.039)
                                        ),
                                ...
                                Padding(
                                    padding:
                                        EdgeInsets.only(left: width * 0.028)
                                        ),
                            ...
                            Row(
                              children: [
                                Container(
                                  width: width * 0.17,
                                  height: height * 0.024,
                                  margin: EdgeInsets.fromLTRB(width * 0.074, height * 0.017, 0, 0),
                                  child: AutoSizeText(
                                    'Возраст',
                                    style: TextStyle(
